		class List{
			...
			display(){
				...
				str+=`<li class="listsItem" index="${this.res[i].goodsId}">
					  ...
					  <p class="title"><a href="#">${this.res[i].name}</a></p>
					  <p class="price"><a href="#">${this.res[i].price}</a></p>
			...
			addEvent(){
				var that = this;
				this.conts.addEventListener("click",function(eve){
		...
		new List({
			...
			conts:document.getElementsByClassName("tijiao"),
